    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult TrainModels()
        {
            ...
            new TextLoader.Column(
              name: nameof(ProductCobougth.ProductID),
              dataKind: DataKind.UInt32,
              source: new [] { new TextLoader.Range(0) },
              keyCount: new KeyCount(77)),
            new TextLoader.Column(
              name: nameof(ProductCobougth.CoboughtProductID),
              dataKind: DataKind.UInt32,
              ...
              keyCount: new KeyCount(77))
                ...
                var options = new MatrixFactorizationTrainer.Options
                {
                    ...
                    nameof(ProductCobougth.ProductID),
                    MatrixRowIndexColumnName =
                    nameof(ProductCobougth.CoboughtProductID),
            ...
            var model = CreateHomeIndexViewModel();
            model.MillisSeconds = stopWatch.ElapsedMilliseconds;
            return View("Index", model);
        }
        ...
        public IActionResult Cart(int? id)
        {
            ...
            {
                model.Cart.CartItems = cartCookie.Split('-').Select(item =>
                  new CartItem
                  {
            ...
            if (System.IO.File.Exists(GetDataPath("germany-model.zip")))
            {
                ...
                var predictionEngine = mlContext.Model.CreatePredictionEngine
                  <ProductCobougth, Recommendation>(modelGermany);
